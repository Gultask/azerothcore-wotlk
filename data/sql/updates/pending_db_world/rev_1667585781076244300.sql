...
DELETE FROM `gameobject` WHERE `guid` IN (75314, 75315, 75316, 75362, 75363, 75364, 75215, 75216, 75217, 75236, 75237, 75238, 75221, 75222, 75223,75341,75342,75343,75383,75384,75385,75374,75375,75376,75377,75378,75379,75380,75381,75382,75479,75480,75481,75482,75411,75412,75413,75414) AND `id` IN (1731, 1732, 1733, 1735, 2040, 1734, 2047);
-- Delete old pools
...
-- Tin/Silver DOEST NOT share with Copper
DELETE FROM `gameobject` WHERE `id`=1731 AND `guid` IN (75272,75275,75278,75281,75284,75287,75290,75293,75296,75299,75302,75305,75308,75311,75320,75323,75326,75329,75332,75335,75338,75344,75347,75350,75353,75356,75365,75368,75389);
